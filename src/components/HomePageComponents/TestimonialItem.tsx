...
const TestimonialItem = () => {
  return (
		...
		<section className=" bg-[#3d1d98] dark:bg-gray-800 dark:text-gray-100 ">
		...
		<div className="flex flex-col max-w-sm mx-4 my-6 shadow-xl">
			<div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-900">
				<p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-100">
					...
					</svg>I have been using TradeSmart for several months now and I am extremely impressed with the consistent returns I have been able to achieve. The platform is user-friendly and the automated trading systems have made it extremely efficient for me to make trades. The customer service is also outstanding and they are always available to assist me with any questions or concerns I may have. I highly recommend TradeSmart to anyone looking to take their trading to the next level.
